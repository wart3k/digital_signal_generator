#ifndef DIGITAL_SIGNAL_GENERATOR_SINUS_H
#define DIGITAL_SIGNAL_GENERATOR_SINUS_H

#include "functions_interface.h"

class Sinus : public FunctionsInterface {
    Sinus(float amplitude, float offset, std::uint32_t samples_per_second, std::uint32_t frequency, std::int16_t phase);
    ~Sinus() = default;
...
#endif //DIGITAL_SIGNAL_GENERATOR_SINUS_H
