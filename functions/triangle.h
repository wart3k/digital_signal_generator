#ifndef DIGITAL_SIGNAL_GENERATOR_TRIANGLE_H
#define DIGITAL_SIGNAL_GENERATOR_TRIANGLE_H

#include "functions_interface.h"

class Triangle : public FunctionsInterface {
public:
    Triangle(float amplitude, float offset, std::uint32_t samples_per_second, std::uint32_t frequency, std::int16_t phase);
    ~Triangle() = default;
...
#endif //DIGITAL_SIGNAL_GENERATOR_TRIANGLE_H
